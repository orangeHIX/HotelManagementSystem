...
public class DateConvertor {
    ...
    public static Calendar convertDateToStandardCheckInDateTime(Calendar dateCheckIn){
    ...
    public static Calendar convertDateToStandardCheckOutDateTime(Calendar dateCheckOut){
        Calendar datetime = Calendar.getInstance();
